...
Now repeat the process for PHP version 8.1. Install `php74` and `php74-php-fpm`.
...
![PHP 7.3 info page](https://assets.digitalocean.com/articles/67125/php73.png) ![PHP 8.1 info page](https://assets.digitalocean.com/articles/67125/php74.png)

Note the titles. The first page indicates that site1.your\_domain deployed PHP version 7.3. The second indicates that site2.your\_domain deployed PHP version 8.1.
